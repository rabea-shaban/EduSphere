...
import { Download, Eye, Edit2, Trash2, RotateCcw, FileText, Image as ImageIcon, Video, Archive, Music, Code, File, Copy, Check } from "lucide-react";
...
export function FileTableView({
  ...
  const handleCopyUrl = (file: FileAsset) => {
            ...
            {files.map((file) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => onPreview(file)}>
                      ...
                      <div className="truncate">
                        ...
                        <span className="uppercase text-[10px] text-slate-400 font-mono">{file.extension}</span>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="py-3 px-4">
                    <span className="px-2.5 py-1 rounded-lg bg-orange-500/10 text-[#F58220] text-[11px] font-bold">
                      {file.folder}
                    </span>
                  </td>
