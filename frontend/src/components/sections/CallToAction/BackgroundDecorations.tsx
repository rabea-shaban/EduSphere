...
export function BackgroundDecorations() {
  return (
    <div aria-hidden className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-500/10 dark:bg-blue-400/20 rounded-full blur-3xl" />
      ...
      >
        <path
          ...
          className="fill-[#1E73D8] dark:fill-white opacity-40"
        />
      </svg>
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="absolute top-12 right-[32%] text-[#1E73D8] dark:text-white text-lg font-black opacity-80 select-none"
      >
        ✦
      </motion.div>
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="absolute bottom-16 right-[12%] text-[#1E73D8] dark:text-white text-xs font-black opacity-70 select-none"
      >
        ✦
      </motion.div>
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="absolute top-24 left-[44%] text-[#1E73D8] dark:text-white text-sm font-black opacity-80 select-none"
      >
        ✦
      </motion.div>
    </div>
