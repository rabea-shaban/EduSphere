  ...
  const handlePrint = () => {
    ...
    frameDoc.write(`
      ...
      <html dir="rtl" lang="ar">
        <head>
          <title>EduSphere Certificate - ${certCode}</title>
        ...
        <body>
          <div class="cert-body">
            ...
            <div class="body-content">
              ...
              <div>
                <div class="course-title">« ${course?.title || "أساسيات البرمجة وتطوير الويب"} »</div>
              </div>
              <div class="meta-tags">
                <span class="tag-green">بتقدير عام: <strong>ممتاز (100%)</strong></span>
                <span class="tag-slate">تاريخ الإصدار: <strong>${new Date().toLocaleDateString("ar-EG", { day: "numeric", month: "long", year: "numeric" })}</strong></span>
              </div>
            </div>

            <div class="signatures-grid">
              <div class="sig-box">
                <div class="sig-line">${course?.teacherName || "Eng Rabea Shaban"}</div>
                <div class="sig-name">${course?.teacherName || "Eng Rabea Shaban"}</div>
