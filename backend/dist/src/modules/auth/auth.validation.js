...
exports.updateProfileSchema = joi_1.default.object({
    firstName: joi_1.default.string().trim().min(2).max(50).optional().allow('', null),
    lastName: joi_1.default.string().trim().min(2).max(50).optional().allow('', null),
    phone: joi_1.default.string().trim().min(6).max(20).optional().allow('', null),
    gender: joi_1.default.string().optional().allow('', null),
    dateOfBirth: joi_1.default.any().optional(),
    avatar: joi_1.default.string().optional().allow('', null),
    stage: joi_1.default.string().optional().allow('', null),
    grade: joi_1.default.string().optional().allow('', null),
    system: joi_1.default.string().optional().allow('', null),
    stream: joi_1.default.string().optional().allow('', null),
    bio: joi_1.default.string().optional().allow('', null),
    governorate: joi_1.default.string().optional().allow('', null),
    nationalId: joi_1.default.string().optional().allow('', null),
})
    .min(1)
    .unknown(true)
    .messages({
...
exports.updateAvatarSchema = joi_1.default.object({
    avatar: joi_1.default.string().trim().required().messages({
