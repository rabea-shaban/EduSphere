...
router.get('/', authMiddleware_1.protect, unit_controller_1.getAllUnits);
router.get('/:id', authMiddleware_1.protect, (0, validationMiddleware_1.validationMiddleware)({ params: user_validation_1.userIdSchema }), unit_controller_1.getUnitById);
