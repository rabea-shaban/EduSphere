...
router.get('/', authMiddleware_1.protect, course_controller_1.getAllCourses);
router.get('/:id', authMiddleware_1.protect, (0, validationMiddleware_1.validationMiddleware)({ params: user_validation_1.userIdSchema }), course_controller_1.getCourseById);
