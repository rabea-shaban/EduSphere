...
router.delete('/:id', (0, validationMiddleware_1.validationMiddleware)({ params: user_validation_1.userIdSchema }), message_controller_1.deleteMessage);
router.patch('/conversation/:conversationId/seen', (0, validationMiddleware_1.validationMiddleware)({ params: conversationIdParamsSchema }), message_controller_1.markConversationSeen);
