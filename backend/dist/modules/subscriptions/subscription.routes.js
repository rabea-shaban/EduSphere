...
router.get('/', authMiddleware_1.protect, subscription_controller_1.getAllPlans);
router.get('/:id', authMiddleware_1.protect, (0, validationMiddleware_1.validationMiddleware)({ params: user_validation_1.userIdSchema }), subscription_controller_1.getPlanById);
