...
import { updateProgressSchema, courseIdParamSchema } from './progress.validation';
...
router.get('/course/:courseId', protect, validationMiddleware({ params: courseIdParamSchema }), getCourseProgress);
